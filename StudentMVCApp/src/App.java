...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        /*  Для первоначального создания списка
...
*/
    ...
    /** Создаем model и передаем список студентов */
        iGetModel model = new Model(students);

        // Экземпляр класса FileRepo
        iGetModel modeFileRepo = fileRepo;



        iGetView view = new View();
        Controller control = new Controller(view, modeFileRepo );
        control.run();
    }
}
